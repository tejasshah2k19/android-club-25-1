package com.royal.androidclub25.fragment;
...
import com.royal.androidclub25.R;
...
public class CallFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
           edtFirstName =  view.findViewById(R.id.edtCallFgName);
           edtContactNum = view.findViewById(R.id.edtCallFgContact);
